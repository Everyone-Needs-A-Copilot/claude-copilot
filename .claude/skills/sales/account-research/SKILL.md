...
```
If CRM available (e.g. copilot crm):
1. Run: copilot crm clients list --search "<company>"
   to find the client/account record. If copilot crm is unavailable, skip this step.
2. Get related contacts from the accounts table.
3. Check for opportunity history.
4. Review activity notes.
```
