...
when_to_use:
  - Defining a design token system for colors, spacing, or typography
  - Specifying component states across all interactive conditions
  - Verifying WCAG 2.1 AA compliance for contrast and touch targets
  - Building a consistent, accessible design system
  - Reviewing components for missing states or hard-coded values
---
